...
let texts = document.getElementsByClassName("class__title");
for (let i = 0; i < texts.length; i++) {
  texts[i].innerHTML = texts[i].innerHTML.slice(0, 25);
}

let text = document.getElementsByClassName("class__text");
for (let i = 0; i < text.length; i++) {
	text[i].innerHTML = text[i].innerHTML.slice(0, 125)+"...";
}

window.addEventListener('load', () => {
	let activeTab = document.querySelector(".tab-btn");
	activeTab.classList.add("active-btn");
})